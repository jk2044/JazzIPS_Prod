...
class AgentSalesController extends Controller
{
    public function sales()
    {
        ...
        return view('agent.sales', compact('agent'));
    }
    ...
    public function transaction()
    {
        ...
        return view('agent.transaction', compact('agent','plan_information', 'plansAndProducts'));
    }
    ...
    public function showAgentData()
    {
        ...
        return view('agent.SucessSales', compact('transactions'));
    }
    ...
    public function FailedAgentReports()
    {
        ...
        return view('agent.FailedSales', compact('Failedtransactions'));
